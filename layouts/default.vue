<template>
  ...
  <footer class="page__footer">Pixelate BV &#169; 2003 - <span id="copyrightYear">{{currentYear}}</span> // Chamber of Commerce 32144761</footer>
  </div>
</template>
<script>
...
.video__filter {
    ...
    width: 100%;
    height: 100%;
    background-color: rgba(var(--global--color--primary--500), 0.9);
}
.video__source {
    position: absolute;
    bottom: 0;
